...
class DocumentReviewerApp {
    ...
    updateStatsDisplay(stats) {
        ...
        document.getElementById('validChanges').textContent = stats.valid_changes || 0;
        document.getElementById('defectRate').textContent = (stats.defect_rate_per_thousand || 0).toFixed(1) + '‰';
    }
